...
$ladder_eu = <<<EOS
<div style="text-align: center;"><iframe src="http://binarybeast.com/xGW21307300/full" class="binarybeast" width="760" height="600" scrolling="auto" frameborder="0" marginwidth="0" marginheight="0">
</iframe></div>
EOS;

$ladder_us = <<<EOS
<div style="text-align: center;"><iframe src="http://binarybeast.com/xGW21307241/full" class="binarybeast" width="760" height="600" scrolling="auto" frameborder="0" marginwidth="0" marginheight="0">
</iframe></div>
EOS;
...
<script>
 var curIndex = 0;
 var curLang = "_en";
 var ids = ["updatemain", "updaterules", "updatereg", "updateladder_eu", "updateladder_us"];
function toggle(i) {
  $("#updatemain_en").hide();
  $("#updatemain_fr").hide();
  $("#updatemain_es").hide();
  ...
  $("#updatereg_es").hide();
  $("#updatereg_de").hide();
  $("#updateladder_eu").hide();
  $("#updateladder_us").hide();
...
<h4 style="text-align: center;"><a class="nodec" id="updatemainl" style="color: #ff0000;" onclick="toggle(0)" href="javascript:void(0)">MAIN</a> | <a class="nodec" id="updateregl" onclick="toggle(2)" href="javascript:void(0)">REGISTRATION</a> | <a class="nodec colorbox" href="http://www.guildwars2.com/pvp-invitational-tournament">ALL INFO</a> | <a class="nodec" id="updateladder_eu" onclick="toggle(3)" href="javascript:void(0)">EU LADDER</a> | <a class="nodec" id="updateladder_us" onclick="toggle(4)" href="javascript:void(0)">US LADDER</a></h4>
&nbsp;
...
<div style="display:none" id="updateladder_eu" class="ck">
<?=$ladder_eu?>
</div>
<div style="display:none" id="updateladder_us" class="ck">
<?=$ladder_us?>
</div>